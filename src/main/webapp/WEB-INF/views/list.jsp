...
<script type="text/javascript"
	src="${APP_PATH}/static/js/jquery-1.7.1.min.js"></script>
<!-- 引入bootstrap样式 -->
<link
	href="${APP_PATH}/static/bootstrap-3.3.7-dist/css/bootstrap.min.css"
	rel="stylesheet">
<script
	src="${APP_PATH}/static/bootstrap-3.3.7-dist/bootstrap/3.3.7/js/bootstrap.min.js"></script>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<!-- 分页文字信息 -->
			<div class="col-md-6">当前${pageInfo.pageNum }页，总${pageInfo.pages }页,总共${ pageInfo.total}条记录
			</div>
			<!-- 分页条信息 -->
			<div class="col-md-6">
